...
All of the calibrations are mapped to interpolated functions that will return a value based on input values
'''
...
del bandgap_i
del am_1_5
j1sunf = lambda bandgap: integrate.simps(
    am15f(np.arange(bandgap, 4, 0.001)), np.arange(bandgap, 4, 0.001)
)
#######################################################################################
# Voc, radiative limit:
